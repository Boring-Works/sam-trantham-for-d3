...
export function HerStory() {
  return (
    <section id="story" className="bg-surface text-text px-6 py-20 md:py-32">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-display mb-10 text-primary">Born Here. Raised Here. Fighting for Here.</h2>
        ...
        <div className="space-y-6 text-lg leading-relaxed">
          ...
          <p>
            While serving as commissioner, Samantha worked in an emergency room during COVID. She spent two and a half years at Pruitt Healthcare caring for seniors.
          </p>

          <blockquote className="border-l-4 border-accent pl-6 py-2 my-8 text-xl font-display text-primary italic">
            "I absolutely loved it," she said. "I had a whole building full of grandparents, and I loved every one of them."
          </blockquote>
