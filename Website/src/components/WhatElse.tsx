...
const ACCOMPLISHMENTS: Accomplishment[] = [
  {
    ...
    body: 'After the biosolids fight, officials proposed relocating the Boys and Girls Club to a site next to Copperhill Industries — inside the EPA Copper Basin Mining District Superfund site. The buildings had asbestos and lead paint. Samantha looked at the EPA data herself and introduced a resolution to find a safer location.',
    ...
    matters: 'The kids in this program now get a building that isn\'t sitting on contaminated ground.',
  },
  {
    date: '2023',
    title: 'Brought Jobs and Scholarships',
  ...
  },
  {
    ...
    matters: 'The outfitters, restaurants, and gas stations that depend on river traffic stay in business.',
  },
  {
    date: 'May 2025',
    ...
    outcome: 'Passed 9–0.',
    matters: 'No 24/7 industrial hum across the ridge. No utility bills going up to feed the data centers.',
  },
]
